...
static SECTIONS: &[Section] = &[
    ...
    Section {
        ...
        rows: &[
            ...
            ("prefix y", "copy what a drag selected"),
            ("prefix /", "search this pane's scrollback"),
    ...
    Section {
        ...
        rows: &[
            ...
            ("esc", "leaves a launched conversation, or clears the box"),
            ("up/down pgup/pgdn", "move the transcript, not the pane's ring"),
            (
                "prefix shift+o",
                "read the conversation this agent launched — newest first",
            ),
            ("prefix y", "copy the code block you are looking at"),
            ("prefix /", "search this transcript · n/N step · esc done"),
            ("prefix shift+c", "take the line left at the pane's own keyboard"),
            (
                "1..9 on an empty box",
