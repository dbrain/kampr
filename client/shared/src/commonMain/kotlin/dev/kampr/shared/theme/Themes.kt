...
val SoftFamily = family(
    ...
    dark = Palette(
        ...
        text = Color(0xFFE8EAF0), dim = Color(0xFF9DA2B0), mute = Color(0xFF8B92A1),
        ...
        idle = Color(0xFF8C92A3), done = Color(0xFF58D68D),
    ),
    light = Palette(
        ...
        text = Color(0xFF12151B), dim = Color(0xFF505665), mute = Color(0xFF5C6272),
        ...
        idle = Color(0xFF5A6377), done = Color(0xFF0F6B45),
    ),
...
val PhosphorFamily = family(
    ...
    dark = Palette(
        ...
        text = Color(0xFFCDD6CD), dim = Color(0xFF8F998F), mute = Color(0xFF7D8A7D),
        ...
        idle = Color(0xFF7D8B7D), done = Color(0xFF57C46B),
    ),
    light = Palette(
        ...
        text = Color(0xFF0F150D), dim = Color(0xFF4C5548), mute = Color(0xFF596252),
        ...
        idle = Color(0xFF596253), done = Color(0xFF1D5E2A),
    ),
...
val WarmFamily = family(
    ...
    dark = Palette(
        ...
        text = Color(0xFFEFE7DC), dim = Color(0xFFA49A90), mute = Color(0xFF958B7E),
        ...
        idle = Color(0xFF988A7B), done = Color(0xFF7FB069),
    ),
    light = Palette(
        ...
        text = Color(0xFF1C1610), dim = Color(0xFF5C5144), mute = Color(0xFF685E4F),
        ...
        idle = Color(0xFF695D4A), done = Color(0xFF3A6127),
    ),
...
val BrutalistFamily = family(
    ...
    dark = Palette(
        ...
        text = Color(0xFFFFFFFF), dim = Color(0xFF8A8A8A), mute = Color(0xFF7A7A7A),
        ...
        idle = Color(0xFF7A7A7A), done = Color(0xFFFFFFFF),
    ),
    light = Palette(
        ...
        idle = Color(0xFF717171), done = Color(0xFF000000),
    ),
