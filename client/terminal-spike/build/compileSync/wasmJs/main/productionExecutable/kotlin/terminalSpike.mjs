...
import { importObject, setWasmExports } from './terminalSpike.import-object.mjs'
...
const wasmFilePath = './terminalSpike.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./terminalSpike.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
